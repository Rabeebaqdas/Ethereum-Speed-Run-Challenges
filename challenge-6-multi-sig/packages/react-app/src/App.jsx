...
// let _base_url = document.URL;
// console.log("_base_url", _base_url.slice(0, -1));
// _base_url = _base_url.split(":")
// console.log("_base_url", _base_url);
// console.log("_base_url", `${_base_url[0] + ":" + _base_url[1] + ":49832/"}`);
// const poolServerUrl = `${_base_url[0] + ":" + _base_url[1] + ":49832/"}`;

const poolServerUrl = "https://backend.multisig.holdings:49832/";
// const poolServerUrl = "backend.multisig.holdings:49832";
// const poolServerUrl = "http://localhost:49832/";
console.log("_base_url", poolServerUrl);
